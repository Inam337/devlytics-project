...
export class GoalsController {
  ...
  @ApiOperation({
    summary: 'Create an improvement goal with a measured baseline',
  })
  create(
    ...
    return this.goalsService.create(organizationId, dto, {
      actorId: userId,
      ...client,
    });
  }
  ...
  @ApiOperation({
    summary: 'Edit a goal, or abandon it (completion is never set manually)',
  })
  update(
    @OrganizationId() organizationId: string,
    @Param('id', uuid()) id: string,
    ...
    return this.goalsService.update(organizationId, id, dto, {
      actorId: userId,
      ...client,
    });
  }
  ...
  remove(
    ...
    return this.goalsService.remove(organizationId, id, {
      actorId: userId,
      ...client,
    });
  }
  ...
  @ApiOperation({
    summary: 'Re-measure progress against the latest analysis run',
  })
  recheck(
    @OrganizationId() organizationId: string,
    @Param('id', uuid()) id: string,
